...
var Physijs = (function() {
	...
	// Physijs.Scene
	Physijs.Scene = class extends THREE.Scene { constructor ( params ) { // EDIT
		super();
		var self = this;
	...
	// Phsijs.Mesh
	Physijs.Mesh = class extends THREE.Mesh { constructor ( geometry, material, mass ) { // EDIT
		super(); 
	...
	// Physijs.SphereMesh
	Physijs.SphereMesh = class extends THREE.Mesh { constructor ( geometry, material, mass ) { // EDIT
		super();
		var self = this;
		// Physijs.Mesh.call( this, geometry, material, mass );
